...
MD_74HC4051_init (void) {
	GPIO_PinModeSet(gpioPortB, 11U, gpioModePushPull, 0);
	GPIO_PinModeSet(gpioPortB, 13U, gpioModePushPull, 0);
	GPIO_PinModeSet(gpioPortB, 14U, gpioModePushPull, 0);
}
